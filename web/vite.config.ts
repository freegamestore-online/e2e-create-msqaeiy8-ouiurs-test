...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-msqaeiy8-ouiurs-test",
        short_name: "Create Canary e2e-create-msqaeiy8-ouiurs-test",
        description: "Create Canary e2e-create-msqaeiy8-ouiurs-test — free forever",
        start_url: "/",
        display: "standalone",
